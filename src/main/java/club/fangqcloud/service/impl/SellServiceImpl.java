...
public class SellServiceImpl implements club.fangqcloud.service.SellService {
    ...
    public ArrayList<Sell> querySell(Product productObj,/* Customer customerObj, */String sellDate, String payWay/*, String logistics, String wayNumber*/, int currentPage) throws Exception {
    	...
    	if(null != productObj && productObj.getProductId()!= null && productObj.getProductId()!= 0)  where += " and sell.productObj=" + productObj.getProductId();
    //	if(null != customerObj && customerObj.getCustomerId()!= null && customerObj.getCustomerId()!= 0)  where += " and sell.customerObj=" + customerObj.getCustomerId();
    	if(!sellDate.equals("")) where = where + " and sell.sellDate like '%" + sellDate + "%'";
    	if(!payWay.equals("")) where = where + " and sell.payWay like '%" + payWay + "%'";
    //	if(!logistics.equals("")) where = where + " and sell.logistics like '%" + logistics + "%'";
    //	if(!wayNumber.equals("")) where = where + " and sell.wayNumber like '%" + wayNumber + "%'";
