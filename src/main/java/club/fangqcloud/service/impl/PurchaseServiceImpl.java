...
public class PurchaseServiceImpl implements club.fangqcloud.service.PurchaseService {
    ...
    public ArrayList<Purchase> queryPurchase(Product productObj, String purchaseDate, Supplier supplierObj, int currentPage) throws Exception {
    	...
    	if(null != productObj && productObj.getProductId()!= null && productObj.getProductId()!= 0)  where += " and purchase.productObj=" + productObj.getProductId();
    	if(!purchaseDate.equals("")) where = where + " and purchase.purchaseDate like '%" + purchaseDate + "%'";
    	if(null != supplierObj && supplierObj.getSupplierId()!= null && supplierObj.getSupplierId()!= 0)  where += " and purchase.supplierObj=" + supplierObj.getSupplierId();
