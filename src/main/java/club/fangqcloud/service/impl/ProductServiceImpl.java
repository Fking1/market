...
public class ProductServiceImpl implements  ProductService {
    ...
    public ArrayList<Product> queryProduct(ProductClass productClassObj, String productName, Supplier supplierObj/*, String addTime*/, int currentPage) throws Exception {
        ...
        if(null != productClassObj && productClassObj.getClassId()!= null && productClassObj.getClassId()!= 0)  where += " and product.productClassObj=" + productClassObj.getClassId();
        if(!productName.equals("")) where = where + " and product.productName like '%" + productName + "%'";
        if(null != supplierObj && supplierObj.getSupplierId()!= null && supplierObj.getSupplierId()!= 0)  where += " and product.supplierObj=" + supplierObj.getSupplierId();
      //  if(!addTime.equals("")) where = where + " and product.addTime like '%" + addTime + "%'";
